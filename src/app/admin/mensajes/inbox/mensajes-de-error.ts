...
const MENSAJES: Record<string, string> = {
  ...
  PHONE_CLAIMED_BY_ANOTHER_LEAD: "Ese número de WhatsApp ya pertenece a otro contacto.",
  PHONE_ALREADY_REGISTERED: "Ya existe un contacto con este número. Búscalo en «Contacto existente».",
  ALREADY_LINKED: "Esta conversación ya está vinculada a un contacto.",
