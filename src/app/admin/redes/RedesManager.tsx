...
export function RedesManager({
  ...
  const accountState = (account: Account) => !account.isActive ? "Inactiva" : account.connectorState === "SIMULATION" ? "En simulación" : account.connectionStatus === "READY" ? "Conexión validada" : presentAdminValue(account.connectionStatus);
