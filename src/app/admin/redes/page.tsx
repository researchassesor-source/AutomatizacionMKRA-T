...
export default async function SocialPage() {
  ...
  return <main className="container admin-shell"><AdminNav /><AdminPageHeader eyebrow="Contenido y campañas" title="Redes sociales" description="Coordina cuentas, publicaciones y calendarios de contenido desde un solo lugar." /><IntegrationStatusPanel only={["facebook", "instagram", "tiktok", "whatsapp", "meta_ads"]} /><TikTokPanel /><RedesManager
