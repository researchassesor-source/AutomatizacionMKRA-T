 ...
 *
 * Son diez y no once: el cierre de sesion anuncia cual es la siguiente
 * ("continuaremos con..."), asi que en un curso de una sesion no tiene nada que
 * decir y no se programa. El cierre del curso lo cubren `course_complete` y
 * `survey`.
 */
