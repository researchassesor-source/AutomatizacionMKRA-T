...
export const courseCaptureMappings = [
  ...
  {
    officialCourseSlug: "litigacion-penal-con-enfoque-intercultural",
    crmCourseSlug: "litigacion-penal-con-enfoque-intercultural",
    officialCourseUrl: "https://ra-training.com/cursos/litigacion-penal-con-enfoque-intercultural/",
    crmFormUrl: crmFormUrl("litigacion-penal-con-enfoque-intercultural"),
    title: "Litigación penal con enfoque intercultural",
    category: "Derecho",
    duration: "3 sesiones",
    modality: "100% online",
    startDate: "7 de septiembre",
    endDate: "9 de septiembre",
    schedule: "Lunes, Martes y Miércoles 19:00",
    trainer: null,
    published: true,
    catalogVisible: true,
    hasOfficialPage: true,
  ...
  {
    officialCourseSlug: "domina-el-sri-desde-cero",
    crmCourseSlug: "domina-el-sri-desde-cero",
    officialCourseUrl: "https://ra-training.com/cursos/domina-el-sri-desde-cero/",
    crmFormUrl: crmFormUrl("domina-el-sri-desde-cero"),
    title: "Domina el SRI desde Cero",
  ...
  {
    officialCourseSlug: "archicad-bim-desde-cero-representacion-tecnica-y-modelado-digital",
    crmCourseSlug: "archicad-bim-desde-cero-representacion-tecnica-y-modelado-digital",
    officialCourseUrl: "https://ra-training.com/cursos/archicad-bim-desde-cero-representacion-tecnica-y-modelado-digital/",
    crmFormUrl: crmFormUrl("archicad-bim-desde-cero-representacion-tecnica-y-modelado-digital"),
    title: "Archicad BIM desde Cero",
    category: "Arquitectura y BIM",
    duration: "5 sesiones",
    modality: "100% online",
    startDate: "21 de septiembre",
    endDate: "25 de septiembre",
    schedule: "Lunes a Viernes 19:00",
    trainer: null,
    published: true,
    catalogVisible: true,
    hasOfficialPage: true,
